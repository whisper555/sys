package com.hb.sys.tools.excel;
...
ClassNotFoundException, IntrospectionException, ParseException, java.beans.IntrospectionException {
        // 创建新的Excel工作簿
    ...
    public static void createTableRows(XSSFSheet sheet, Map<Integer, List<ExcelBean>> map, List objs, Class clazz)
            ...
            ClassNotFoundException, ParseException, java.beans.IntrospectionException {
