	 ...
	 <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="teacher.t_name" htmlEscape="院系" class="form-control"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="p_max" htmlEscape="人数" class="form-control required" />
					</td>
					<td class="width-15 active"><label class="pull-right">分数：<font color="red">*</font></label></td>
					<td class="width-35">
						<input value="${student.s_score}" class="form-control required" />
					</td>
