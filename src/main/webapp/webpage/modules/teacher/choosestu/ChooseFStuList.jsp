...
<body class="childrenBody">
 			<div class="ibox-title">   
                  <a class="btn btn-outline btn-default" href="${ctx }/teacher/choosestu/list?tid=${sessionScope.Tea_user.id }&period=3" >刷新</a> 
			 ...
			 <div class="ibox-content">
                        <table class="table table-striped table-bordered table-hover dataTables-example">
							...
							<tr class="gradeX">
								...
								<td class="center">			
										<a class="btn btn-outline btn-default" href="${ctx }/teacher/choosestu/choose?id=${stu.id}&period=3&pid=${stu.s_wish1.id}&tid=${sessionScope.Tea_user.id }" onclick="return countlimit('${sessionScope.Tea_user.id }');" >选择</a>
								</td>
							</tr>
						</c:forEach>
                        </table>
